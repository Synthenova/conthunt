...
--
-- Name: billing_subscriptions; Type: TABLE; Schema: conthunt; Owner: conthunt_app
--

CREATE TABLE conthunt.billing_subscriptions (
...
ALTER TABLE conthunt.billing_subscriptions OWNER TO conthunt_app;
...
--
-- Name: billing_subscriptions billing_subscriptions_pkey; Type: CONSTRAINT; Schema: conthunt; Owner: conthunt_app
--

ALTER TABLE ONLY conthunt.billing_subscriptions
    ADD CONSTRAINT billing_subscriptions_pkey PRIMARY KEY (id);


--
-- Name: billing_subscriptions billing_subscriptions_subscription_id_key; Type: CONSTRAINT; Schema: conthunt; Owner: conthunt_app
--

ALTER TABLE ONLY conthunt.billing_subscriptions
    ADD CONSTRAINT billing_subscriptions_subscription_id_key UNIQUE (subscription_id);
...
--
-- Name: idx_billing_subscriptions_customer_id; Type: INDEX; Schema: conthunt; Owner: conthunt_app
--

CREATE INDEX idx_billing_subscriptions_customer_id ON conthunt.billing_subscriptions USING btree (customer_id);


--
-- Name: idx_billing_subscriptions_last_webhook_ts; Type: INDEX; Schema: conthunt; Owner: conthunt_app
--

CREATE INDEX idx_billing_subscriptions_last_webhook_ts ON conthunt.billing_subscriptions USING btree (last_webhook_ts DESC);


--
-- Name: idx_billing_subscriptions_status; Type: INDEX; Schema: conthunt; Owner: conthunt_app
--

CREATE INDEX idx_billing_subscriptions_status ON conthunt.billing_subscriptions USING btree (status);


--
-- Name: idx_billing_subscriptions_user_id; Type: INDEX; Schema: conthunt; Owner: conthunt_app
--

CREATE INDEX idx_billing_subscriptions_user_id ON conthunt.billing_subscriptions USING btree (user_id);
...
--
-- Name: billing_subscriptions billing_subscriptions_user_id_fkey; Type: FK CONSTRAINT; Schema: conthunt; Owner: conthunt_app
--

ALTER TABLE ONLY conthunt.billing_subscriptions
    ADD CONSTRAINT billing_subscriptions_user_id_fkey FOREIGN KEY (user_id) REFERENCES conthunt.users(id) ON DELETE CASCADE;
...
--
-- Name: billing_subscriptions; Type: ROW SECURITY; Schema: conthunt; Owner: conthunt_app
--

ALTER TABLE conthunt.billing_subscriptions ENABLE ROW LEVEL SECURITY;

--
-- Name: billing_subscriptions billing_subscriptions_select_own; Type: POLICY; Schema: conthunt; Owner: conthunt_app
--

CREATE POLICY billing_subscriptions_select_own ON conthunt.billing_subscriptions FOR SELECT TO conthunt_app USING ((user_id = (current_setting('app.user_id'::text, true))::uuid));


--
-- Name: billing_subscriptions billing_subscriptions_service_all; Type: POLICY; Schema: conthunt; Owner: conthunt_app
--

CREATE POLICY billing_subscriptions_service_all ON conthunt.billing_subscriptions TO conthunt_service USING (true) WITH CHECK (true);
...
--
-- Name: TABLE billing_subscriptions; Type: ACL; Schema: conthunt; Owner: conthunt_app
--

GRANT ALL ON TABLE conthunt.billing_subscriptions TO conthunt_service;
