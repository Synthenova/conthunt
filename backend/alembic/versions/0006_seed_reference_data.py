...
def upgrade() -> None:
    ...
    op.execute(
        ...
        VALUES
            ('c78dea23-0164-48a7-8740-b1285d3b582a'::uuid, 'search_query', 1, '2026-01-11 09:29:02.552484+00'::timestamptz),
            ('a5fb53b9-e095-455c-a465-5c0b2675c7ef'::uuid, 'video_analysis', 2, '2026-01-11 09:29:02.552484+00'::timestamptz),
            ('dda559e1-36f9-4f50-a52c-d03377532f7f'::uuid, 'index_video', 5, '2026-01-11 09:29:02.552484+00'::timestamptz)
        ...
        VALUES
            (
                '407a685e-1ba5-4479-a0d5-7e47cf7ef026'::uuid,
                'creator',
                'search_query',
                'monthly',
                50,
                '2026-01-19 22:44:10.733166+00'::timestamptz,
                '2026-01-22 18:59:14.788188+00'::timestamptz
            ),
            (
                'aea42ee2-4fa3-46ed-8d11-c7802aaa6d93'::uuid,
                'free',
                'search_query',
                'monthly',
                10,
            ...
            (
                '822ed99e-c7ba-4035-bac8-9cd6415ed2e3'::uuid,
                'pro_research',
                'search_query',
                'monthly',
                300,
        ...
        VALUES
            ('b8ed050b-459e-4d92-b5b3-e6ff0fe4fcb0'::uuid, 'open', 'App Open', '2026-01-19 14:10:08.226694+00'::timestamptz),
            ('ad0e9299-9028-4b95-b96b-101f892d01c7'::uuid, 'analysis', 'Analysis', '2026-01-19 14:10:08.226694+00'::timestamptz),
            ('c8bfb77c-4eb1-4aa5-a16d-866dbb75ae25'::uuid, 'search', 'Search', '2026-01-19 14:10:08.226694+00'::timestamptz)
        ...
        FROM (
            VALUES
                ...
                ('68166f8d-42fb-4337-9088-59ba96d3ee82'::uuid, 'creator', 3, '10 Searches', 'Search', 'search_query', 0, 10, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('fc12469d-7ea5-47d5-bd71-d4e3e77043b6'::uuid, 'pro_research', 3, '10 Searches', 'Search', 'search_query', 0, 10, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('0cb91077-7804-4144-8655-b71f224eef0f'::uuid, 'free', 10, '50 Credits', 'Coins', NULL, 50, 0, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('8b7f8af9-56d3-43e7-803f-9769a047dd75'::uuid, 'creator', 10, '50 Credits', 'Coins', NULL, 50, 0, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('7a5bc16b-d822-44b5-88e9-e968f7a01993'::uuid, 'pro_research', 10, '50 Credits', 'Coins', NULL, 50, 0, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ...
                ('a4fb7e10-cdd3-410d-859d-7e65a84cdb1b'::uuid, 'creator', 50, '100 Credits + 10 Searches', 'Award', 'search_query', 100, 10, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('b0efaadd-2d26-44d9-8ffc-ab6589dc9fa2'::uuid, 'pro_research', 50, '100 Credits + 10 Searches', 'Award', 'search_query', 100, 10, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ...
                ('54c5cae9-ad60-48ee-9352-b9744fb14ce5'::uuid, 'creator', 100, '200 Credits + 20 Searches', 'Crown', 'search_query', 200, 20, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('fe501907-718b-4e8d-a77c-819bfb9e11f2'::uuid, 'pro_research', 100, '200 Credits + 20 Searches', 'Crown', 'search_query', 200, 20, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ...
                ('8a9d7c32-17d9-4347-bd48-776082d5ff4c'::uuid, 'creator', 365, '500 Credits + 50 Searches', 'Sparkles', 'search_query', 500, 50, '2026-01-20 01:17:14.805011+00'::timestamptz),
                ('a98e017c-c405-4a87-9fd9-abc8e37941da'::uuid, 'pro_research', 365, '500 Credits + 50 Searches', 'Sparkles', 'search_query', 500, 50, '2026-01-20 01:17:14.805011+00'::timestamptz)
        ) AS milestone(
            id,
            role,
            days_required,
