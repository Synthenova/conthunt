I want to make an API call to https://api.scrapecreators.com/v1/tiktok/search/top. 

  Please help me write code to make this API call and handle the response appropriately. Include error handling and best practices.

  Here are the details:
  
  Endpoint: GET https://api.scrapecreators.com/v1/tiktok/search/top
...
- publish_time : Time Frame TikTok was posted
