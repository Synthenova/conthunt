...
DELETE https://api.twelvelabs.io/v1.3/assets/{asset_id}

This method deletes the specified asset. This action cannot be undone.

Reference: https://docs.twelvelabs.io/api-reference/upload-content/direct-uploads/delete
...
```java
HttpResponse<String> response = Unirest.delete("https://api.twelvelabs.io/v1.3/assets/6298d673f1090f1100476d4c")
...
$response = $client->request('DELETE', 'https://api.twelvelabs.io/v1.3/assets/6298d673f1090f1100476d4c', [
  'headers' => [
    'x-api-key' => '<apiKey>',
  ],
]);
