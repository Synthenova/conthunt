...
DELETE https://api.twelvelabs.io/v1.3/entity-collections/{entity_collection_id}

This method deletes the specified entity collection. This action cannot be undone.

Reference: https://docs.twelvelabs.io/api-reference/entities/entity-collections/delete
...
info:
  ...
  version: endpoint_entityCollections.delete
paths:
  /entity-collections/{entity_collection_id}:
    delete:
      operationId: delete
      summary: Delete an entity collection
      description: >-
        This method deletes the specified entity collection. This action cannot
        be undone.
      tags:
      ...
      responses:
        '204':
          description: The entity collection has been successfully deleted.
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/entity-collections_delete_Response_204'
        '400':
          description: The request has failed.
          content: {}
components:
  schemas:
    entity-collections_delete_Response_204:
      type: object
      properties: {}
...
```java
HttpResponse<String> response = Unirest.delete("https://api.twelvelabs.io/v1.3/entity-collections/6298d673f1090f1100476d4c")
...
$response = $client->request('DELETE', 'https://api.twelvelabs.io/v1.3/entity-collections/6298d673f1090f1100476d4c', [
  'headers' => [
    'x-api-key' => '<apiKey>',
  ],
]);
