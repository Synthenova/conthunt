...
POST https://api.twelvelabs.io/v1.3/entity-collections/{entity_collection_id}/entities/{entity_id}/assets
...
Reference: https://docs.twelvelabs.io/api-reference/entities/entity-collections/entities/add-assets
...
openapi: 3.1.1
info:
  title: Add assets to an entity
  version: endpoint_entityCollections/entities.createAssets
paths:
  /entity-collections/{entity_collection_id}/entities/{entity_id}/assets:
    post:
      operationId: create-assets
      summary: Add assets to an entity
      description: >
        This method adds assets to the specified entity within an entity
        collection. Assets are used to identify the entity in media content, and
        adding multiple assets can improve the accuracy of entity recognition in
        searches.


        When assets are added, the entity may temporarily enter the "processing"
        state while the platform updates the necessary data. Once processing is
      ...
      parameters:
        - name: entity_collection_id
          ...
          description: >
            ...
            entity to which assets will be added.
          required: true
          schema:
            type: string
        - name: entity_id
          ...
          description: >
            ...
            collection to which the assets will be added.
          required: true
          schema:
            type: string
        - name: x-api-key
      ...
      responses:
        '200':
          description: The assets have been successfully added to the entity.
          content:
            application/json:
              schema:
...
payload = { "asset_ids": ["6298d673f1090f1100476d4c", "6298d673f1090f1100476d4d"] }
headers = {
    "x-api-key": "<apiKey>",
    "Content-Type": "application/json"
}
...
const options = {
  ...
  body: '{"asset_ids":["6298d673f1090f1100476d4c","6298d673f1090f1100476d4d"]}'
};
...
```java
HttpResponse<String> response = Unirest.post("https://api.twelvelabs.io/v1.3/entity-collections/6298d673f1090f1100476d4c/entities/6298d673f1090f1100476d4c/assets")
...
$response = $client->request('POST', 'https://api.twelvelabs.io/v1.3/entity-collections/6298d673f1090f1100476d4c/entities/6298d673f1090f1100476d4c/assets', [
  'body' => '{
  "asset_ids": [
    "6298d673f1090f1100476d4c",
    "6298d673f1090f1100476d4d"
...
let parameters = ["asset_ids": ["6298d673f1090f1100476d4c", "6298d673f1090f1100476d4d"]] as [String : Any]
