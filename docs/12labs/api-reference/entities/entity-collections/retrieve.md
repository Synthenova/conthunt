...
GET https://api.twelvelabs.io/v1.3/entity-collections/{entity_collection_id}

This method retrieves details about the specified entity collection.

Reference: https://docs.twelvelabs.io/api-reference/entities/entity-collections/retrieve
...
openapi: 3.1.1
info:
  title: Retrieve an entity collection
  version: endpoint_entityCollections.retrieve
paths:
  /entity-collections/{entity_collection_id}:
    get:
      operationId: retrieve
      summary: Retrieve an entity collection
      ...
      responses:
        '200':
          description: The entity collection has been successfully retrieved.
          content:
            application/json:
              schema:
...
```java
HttpResponse<String> response = Unirest.get("https://api.twelvelabs.io/v1.3/entity-collections/6298d673f1090f1100476d4c")
...
$response = $client->request('GET', 'https://api.twelvelabs.io/v1.3/entity-collections/6298d673f1090f1100476d4c', [
  'headers' => [
    'x-api-key' => '<apiKey>',
  ],
]);
