...
Reference: https://docs.twelvelabs.io/api-reference/videos/delete
...
info:
  ...
  version: endpoint_indexes/videos.delete
paths:
  /indexes/{index-id}/videos/{video-id}:
    delete:
      ...
      description: >
        ...
        implementations should use the [Delete an indexed
        asset](/v1.3/api-reference/index-content/delete) method.</Info>


        This method deletes all the information about the specified video. This
      ...
      responses:
        '204':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/indexes_videos_delete_Response_204'
        '400':
          description: The request has failed.
          content: {}
components:
  schemas:
    indexes_videos_delete_Response_204:
      type: object
      properties: {}
...
```java
HttpResponse<String> response = Unirest.delete("https://api.twelvelabs.io/v1.3/indexes/6298d673f1090f1100476d4c/videos/6298d673f1090f1100476d4c")
...
$response = $client->request('DELETE', 'https://api.twelvelabs.io/v1.3/indexes/6298d673f1090f1100476d4c/videos/6298d673f1090f1100476d4c', [
  'headers' => [
    'x-api-key' => '<apiKey>',
  ],
]);
